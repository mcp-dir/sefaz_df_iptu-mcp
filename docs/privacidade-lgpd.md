...
SEFAZ DF: IPTU (Emissão Guia) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_df_iptu@mcp.ai](mailto:sefaz_df_iptu@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
